...
MONTH_NAMES = [
    'Nisan', 'Iyar', 'Sivan', 'Tamuz', 'Av', 'Elul', 'Tišri', 'Chešvan',
    'Kislev', 'Tevet', 'Švat', 'Adar', 'Adar 1', 'Adar 2'
]
...
FAST_DAYS = [
    'Com Gedalja', '10. Tevet', 'Taanit Esther', '17. Tamuz', '9. Av'
]
...
FESTIVALS = [
    'Roš Hašana', 'Jom Kipur', 'Sukot', 'Šmini Aceret', 'Simchat Tora',
    'Chanuka', "Tu Bišvat", 'Purim Katan', 'Purim', 'Šušan Purim',
    'Pesach', 'Pesach šeni', "Lag Ba'omer", 'Šavuot', "Tu B'av"
]
