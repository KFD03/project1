...
-transcribed to standard (sephardic/liberal) in Czech pronounciation by KFD
...
PARSHIOS = [
    'Berešit', 'Noach', 'Lech Lecha', 'Vajera', 'Chajej Sara', 'Toldot',
    'Vajece', 'Vajišlach', 'Vaješev', 'Mikec', 'Vajigaš', 'Vajechi',
    'Šemot',  "Va'era", 'Bo', 'Bešalach', 'Yitro',  'Mišpatim', 'Teruma',
    'Tecave', 'Ki Tisa', 'Vajakhel', 'Pekudej', 'Vajikra', 'Cav', 'Šemini',
    'Tazria', 'Mecora', 'Acharej Mot', 'Kedošim', 'Emor', 'Behar',
    'Bechukotaj', 'Bamidbar', 'Naso', "Beha'alotecha", 'Šlach', 'Korach',
    'Chukat', 'Balak', 'Pinchas', 'Matot', 'Masej', 'Devarim', "Va'etchanan",
    'Ekev', "Re'eh", 'Šoftim', 'Ki Tece', 'Ki Tavo', 'Nicavim',
    'Vajelech', 'Haazinu', 'Vezot Habracha'
    ]
